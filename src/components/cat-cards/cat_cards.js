    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <Card className={styles.card + " cardManager"} onMouseEnter={() => {
                    this.setState({
                        isHowering: true
                    });
                }} onMouseLeave={() => {
                    ...
                    <CardActionArea onClick={this.Click} >
                        <img style={imageStyle} className="image-list" src={this.props.item.img1} />
                    </CardActionArea>
                    <a href="#" className="buyData" >{this.props.item.buy}</a>
                    {this.state.isHowering ? <Box>
