    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                {value === 0 && <TabContainer><Latest products = {products}/></TabContainer>}
                {value === 1 && <TabContainer><BestSellers products = {products}/></TabContainer>}
                {value === 2 && <TabContainer>Item Three</TabContainer>}
                <div className="sideBar">
                    <img src="http://epicwoo.com/demo/wp-content/uploads/2018/05/category-banner-2.jpg" /><br></br>
